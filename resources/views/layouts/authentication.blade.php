...
<head>
    ...
    <title>{{ config('app.name', 'Widya') }} {{ $title ?? '' }}</title>
    ...
    <main class="bg-white">
        ...
        <div class="relative flex">
                ...
                <div class="flex flex-col h-full min-h-screen after:flex-1">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                            <!-- Logo -->
                            <a class="block" href="">
                                <img src="{{ asset('assets/logo.svg') }}" alt="Logo PDAM Semarang"
                                    class="w-20 h-20">
                            </a>
                        </div>
                    </div>
            ...
            <div class="absolute top-0 bottom-0 right-0 hidden md:block md:w-1/2" aria-hidden="true">
                <img class="object-cover object-center w-full h-full" src="{{ asset('assets/auth.png') }}"
