<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="/">
            <h1 class="text-yellow-400 font-outline-2 ml-4 font-extrabold text-4xl">NusStory</h1>
        </a>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a href="{{ route('historical-topics.index') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('historical-topics.*') ? 'bg-graydark text-white' : 'text-black' }}">
                    ...
                    <li>
                        <a href="{{ route('historical-figure.index') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('historical-figure.*') ? 'bg-graydark text-white' : 'text-black' }}">
                    ...
                    <li>
                        <a href="{{ route('story-provinces.index') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('story-provinces.*') ? 'bg-graydark text-white' : 'text-black' }}">
