<x-layout>
    <div class="p-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('story-provinces.index') }}" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">
                Kembali
            </a>
        </div>
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('story-province-details.create', ['province_id' => $province->id]) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5">
                Tambah Detail
            </a>
        </div>
